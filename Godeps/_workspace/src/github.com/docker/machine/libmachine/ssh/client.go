...
import (
	...
	"github.com/eris-ltd/eris-cli/Godeps/_workspace/src/golang.org/x/crypto/ssh"
	"github.com/eris-ltd/eris-cli/Godeps/_workspace/src/golang.org/x/crypto/ssh/terminal"
)
...
var (
	baseSSHArgs = []string{
		...
		"-o", "LogLevel=debug", // suppress "Warning: Permanently added '[localhost]:2022' (ECDSA) to the list of known hosts."
